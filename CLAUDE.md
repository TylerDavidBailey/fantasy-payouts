...
- PR titles and commits use Conventional Commits — releases are automated from `main` via semantic-release; Pages deploys run after a successful CI run on `main`.
